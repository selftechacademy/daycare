    ...
    <div className="main-page-container">
      ...
      <div className="main-page">
        ...
        <ul className="main-page-list">
          <li className="main-list-item">Nurturing <span >Hearts</span>,</li>
          <li className="main-list-item">Growing <span >Minds</span>,</li>
          <li className="main-list-item">Where <span >Children</span> Shine!</li>
        </ul>
